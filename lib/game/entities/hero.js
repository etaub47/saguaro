...
.defines(function(){
    ...
    EntityHero = EntityCoreentity.extend({
        ...
        receiveDamage: function(amount, from) {
            ...
            ig.game.stats.hpCurrent = this.health;
            this.climbing = false;
        },
            ...
            if (ig.input.pressed('attack') && (this.attackState == null) && !this.climbing) {
                ...
                switch (this.activeWeapon) {
                    case (1):
                        ...
                        break;
                    case (2):
                        if (!ig.game.stats.useItemById(23))
                            ig.game.errorSFX.play();
                        else {
                            ig.game.spawnEntity(EntityHeroArrow, this.pos.x, this.pos.y, {flip: this.flip});
    ...
    EntityHeroArrow = ig.Entity.extend({
