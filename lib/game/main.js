...
.defines(function(){
    ...
    MyGame = ig.Game.extend({
		...
		freeSans20: new ig.Font('media/freesans20.png'),
		...
		draw: function() {
			...
			if (this.showStats) {
				...
				this.freeSans16.draw("Level: 12", 144, 6);
				this.freeSans16.draw("XP: 12,500 / 14,000", 265, 6);
				this.freeSans16.draw("HP: 190 / 200", 144, 28);
				this.freeSans16.draw("MP: 120 / 150", 265, 28);
				this.freeSans16.draw("Skills: 10 / 12", 390, 28);
			}
		},
