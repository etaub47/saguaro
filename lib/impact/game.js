...
ig.Game = ig.Class.extend({
	...
	// custom code
	addEventEntities: function() {
		this.spawnEntity(EntityHero, this.hero_x, this.hero_y, this.hero_settings);
		if (this.currentLevel == 'X2Y1' && !ig.game.stats.events[0])
			this.spawnEntity(EntityGoldcoin, 284, 88, {pickupEvent: 0});
		if (this.currentLevel == 'X2Y1' && !ig.game.stats.events[1])
			this.spawnEntity(EntityGoldcoin, 520, 120, {pickupEvent: 1});
		if (this.currentLevel == 'X2Y1' && !ig.game.stats.events[2])
			this.spawnEntity(EntityGoldcoin, 764, 136, {pickupEvent: 2});
	},
	...
	loadHeroDeferred: function( p_hero_x, p_hero_y, p_hero_settings ) {
		this.hero_x = p_hero_x;
		this.hero_y = p_hero_y;
		this.hero_settings = p_hero_settings;
	},
